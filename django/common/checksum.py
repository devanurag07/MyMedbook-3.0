...
if __name__ == "__main__":
    new_parm = {
      ...
      "EMAIL": "doss.cclawrance226@gmail.com",
      "MOBILE_NO": "9790584839",
    }

    api_key = 'Deo%PU9ejMm9jyIR'
    checksum = generate_checksum(new_parm, api_key)
    print("\nChecksum Params: ", new_parm)
    print("\nGenerated Checksum: ", checksum)
    print("\nVerify Checksum: ", verify_checksum(new_parm, api_key, checksum))
'''