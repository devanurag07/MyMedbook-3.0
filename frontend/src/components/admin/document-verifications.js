...
class DocumentVerifications extends Component {
  defaultParam = {
  ...
  actionHandler = (param) => {
    if (param.label === "Edit") {
      ...
      this.props.history.push(`/app/doctor/${param.rowData.id}`);
    }
  };
...
export default connect(mapStateToProps, { setBData })(DocumentVerifications);
